...
**Creation:** Via `createNote()` Server Action (`frontend/src/features/notes/actions/notes.actions.ts`).
**Deletion:** Hard-delete is disabled in security rules. Soft-delete via `deletedAt` not yet implemented.
